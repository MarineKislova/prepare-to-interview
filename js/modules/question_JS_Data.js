...
const questionsJSProglibPart2 = [
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Цикл событий в JavaScript – это механизм, который управляет выполнением кода. Он обеспечивает обработку событий и выполнение задач в правильном порядке. Хотя JavaScript работает в однопоточной среде, цикл событий дает возможность обрабатывать асинхронные операции и предотвращает блокировку основного потока выполнения. Когда асинхронная операция (например, запрос к серверу) завершается, она помещает соответствующее событие в очередь событий. Цикл событий обрабатывает задачи в порядке их поступления. Он берет событие из очереди и передает его для выполнения. Если событие содержит обратный вызов или обработчик – вызывается соответствующая функция для выполнения кода, связанного с этим событием. Цикл событий также обрабатывает задачи, связанные с таймерами и промисами. Благодаря циклу событий, JavaScript быстро реагирует на действия пользователя и эффективно использует ресурсы при работе с асинхронными операциями. В приведенном ниже примере, несмотря на то, что setTimeout(firstTask, 0) имеет время ожидания0 секунд, первая задача firstTask()все равно не будет выполнена сразу после secondTask(). Это происходит потому, что JavaScript использует цикл событий для управления выполнением асинхронных операций. Когда мы вызываем setTimeout(), функция firstTask() помещается в очередь событий, – цикл событий начинает обрабатывать эту функцию, когда стек вызовов опустеет.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Оператор опциональной последовательности ?. позволяет получить безопасный доступ к вложенным свойствам объекта – даже в том случае, когда промежуточное свойство отсутствует. Оператор ?.прекращает оценку и возвращаетundefined, если часть после ?. является либоundefined, либо null. let user = {  name: 'Евгений', lastname: 'Онегин', address: {    street: 'Невский проспект', city: 'Санкт-Петербург' }};console.log(user.address?.street); // Невский проспект console.log(user.address?.nonexistent); // undefined",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Рекурсия в программировании – это процесс, в котором функция вызывает саму себя. Рекурсия обычно используется для решения задач, которые можно разбить на более простые подзадачи. В JavaScript рекурсию можно использовать, например, для работы с многоуровневыми массивами и обхода деревовидных структур данных.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  {
    id: 27,
    question: "В чем разница между объявлением функции и функциональным выражением?",
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Объявление функции и функциональное выражение – это два способа определения функций в JavaScript. Объявление функции – это традиционный способ определения функции. Функция создается и присваивается переменной, как любое другое значение. При этом объявленные функции доступны во всем коде, даже до того, как программа достигает того участка, где они определены. Функциональное выражение – это альтернативный способ определения функции: В отличие от традиционной функции, функциональное выражение нельзя вызывать до определения в коде – это приведет к ошибке . Функциональные выражения могут: быть анонимными; формировать замыкания; передаваться в качестве аргументов другим функциям; использоваться как немедленно вызываемые функциональные выражения (IIFE).",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Конструкторы в JavaScript – это специальные функции, используемые для создания объектов. Вот два основных правила при работе с конструкторами: Имя конструктора должно начинаться с заглавной буквы.  Конструктор вызывается при помощи оператора new. Когда мы вызываем конструктор через new, происходит следующее: Создается новый пустой объект и присваивается в this. Выполняется код внутри конструктора. Обычно он модифицирует объектthis, добавляя в него свойства. Значение this возвращается из конструктора как результат.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "В JavaScript для получения списка ключей и значений объекта используются методы Object.keys() и Object.values(). Object.keys() возвращает массив со всеми ключами объекта. Object.values() возвращает массив со всеми значениями свойств объекта. Используя Object.keys() и Object.values(), можно сделать перебор. Или вывести ключи и значения в виде объекта",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  {
    id: 30,
    question: "Приведите примеры нововведений, добавленных в JavaScript в версии ES6",
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Вот всего несколько примеров. ",
      image1: "",
      href2: "https://www.w3schools.com/js/js_es6.asp",
      linkName2: "В ES6 множество нововведений: Деструктуризация объектов и массивов, Шаблонные строки, Стрелочные функции, Параметры по умолчанию, Объявление переменных с помощью let и const, Оператор распространения (позволяет распаковывать элементы массива или объекта для аргументов функции или создания новых массивов/объектов)",
      answer2: "",
      image2: "",
    },
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Наследование классов в ES6 осуществляется с помощью ключевого слова extends, которое следует за именем родительского класса. Родительский класс часто называют базовым классом, а класс, который наследует базовый/родительский класс, называется производным или дочерним",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Генераторы в JavaScript представляют собой специальный тип функций, которые генерируют последовательность значений по одному за раз по мере необходимости, и позволяют приостанавливать и возобновлять свое выполнение (в отличие от обычных функций, которые выполняются до завершения). Генераторы хорошо работают с объектами и упрощают создание потоков данных. Чтобы объявить генератор, используют специальный синтаксис – функцию-генератор. Функция-генератор определяется с помощью символа * после ключевого слова function. function* generateNumbers() {  yield 1;  yield 2;  yield 3;  yield 4;  return 5; }. Генератор возвращает итератор, который можно использовать для контроля над выполнением функции. Основной метод итератора – next(). Когда вызывается next(), выполнение кода продолжается до ближайшего оператора yield. Когда достигнут yield, выполнение функции приостанавливается, и соответствующее значение возвращается во внешний код",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Есть 3 основных метода хранения данных в браузере: LocalStorage и SessionStorage используются для хранения пар ключ-значение. Данные, сохраненные в них, сохраняются после обновления страницы. При этом только LocalStorage может сохранять данные после перезапуска браузера. Оба хранилища могут использовать только строки в качестве ключей и значений, поэтому объекты необходимо преобразовать с помощью JSON.stringify(). Cookie – небольшие строки данных, которые хранятся в браузере. Cookie обычно устанавливаются веб-сервером с использованием заголовка Set-Cookie. Браузер затем автоматически добавляет их почти ко всем запросам на тот же домен с использованием заголовка Cookie. Один экземпляр cookie может содержать до 4 кб данных. В зависимости от браузера, допускается более 20 cookie на сайт. IndexedDB – встроенная база данных, более мощная, чем localStorage. Это NoSQL-хранилище данных в формате JSON внутри браузера, где доступны несколько типов ключей, а значения могут быть практически любым. IndexedDB поддерживает асинхронный доступ, транзакции для обеспечения согласованности данных и создание индексов для эффективного поиска. Позволяет хранить больше данных, чем localStorage, может быть связана с Service Workers и другими технологиями, которые обеспечивают функционирование PWA в оффлайне.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Сессионное хранилище sessionStorage и локальное хранилище localStorage позволяют сохранять данные в формате ключ-значение в браузере. Оба они используются для хранения данных на стороне клиента, но имеют некоторые отличия: Объем хранимых данных – localStorage может хранить до 10 МБ данных, в то время как sessionStorage может хранить только до 5 МБ данных. Срок хранения данных – в localStorage данные не удаляются, когда закрывается браузер или вкладка. И напротив, данные в sessionStorage удаляются, когда закрывается вкладка или окно браузера. Доступность данных – из localStorage данные доступны в любом окне браузера, в то время как данные из sessionStorage доступны только из того же окна браузера, где они были сохранены.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Регулярные выражения (regex) – это паттерны, которые используются для поиска и замены текста в строках. В паттернах используются комбинации специальных символов (шаблоны) и флаги (модификаторы, которые определяют поведение поиска). Регулярные выражения часто используют в комбинации с этими методами:test() – проверка на соответствие шаблону, match() – поиск соответствий, replace() – замена по шаблону, search() – поиск индекса. Составлять регулярные выражения можно с помощью конструктора RegExp или литеральной нотации.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  {
    id: 37,
    question: "В чем заключается разница между WeakSet, WeakMap и обычными Set и Map?",
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "WeakSet и WeakMap – это специальные структуры данных в JavaScript, которые отличаются особенностью хранения ссылок на объекты. В обычных Set и Map хранятся сильные ссылки на объекты. Это значит, что пока существует ссылка на объект в этих структурах, сборщик мусора не удалит этот объект из памяти, даже если больше нигде в коде нет ссылок на него. И напротив, в WeakSet и WeakMap хранятся слабые ссылки. Это означает, что если объект, на который есть ссылка в этих структурах, больше недоступен в коде (т.е. нигде больше нет сильных ссылок на него), то сборщик мусора может удалить этот объект из памяти, даже если в WeakSet или WeakMap все еще есть ссылка на него. Таким образом, использование слабых ссылок позволяет не держать в памяти ненужные больше объекты и экономить память. Кроме того, в WeakMap в качестве ключей могут использоваться только объекты, а не примитивные значения. А в WeakSet хранятся только объекты, без ключей.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "JavaScript позволяет работать с примитивными типами данных – строками, числами, логическими значениями – как с объектами, поскольку у них тоже есть методы. Например, у строк есть методы toUpperCase() и toLowerCase(), у чисел есть методы toFixed() и toPrecision() и т.д. Эта возможность реализована благодаря специальным оберточным объектам для каждого примитивного типа данных. Эти объекты называются: String – для строк, Number – для чисел, Boolean – для логических значений, Symbol – для символов. Когда мы вызываем метод у примитивного значения, например 'test'.toUpperCase(), происходит следующее: Создается временный оберточный объект типа Stringсо значением 'test'. У этого объекта вызывается метод toUpperCase(). Результат возвращается обратно в примитивное значение. Временный оберточный объект удаляется. Таким образом реализуется возможность использовать методы у примитивных типов данных. Благодаря этому механизму, примитивы в JavaScript ведут себя как объекты.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "https://proglib.io/p/voprosy-dlya-podgotovki-k-sobesedovaniyu-po-javascript-chast-2-2024-02-12",
      linkName: "proglib.io",
      answer1: "Для этого в JavaScript используется оператор instanceof. Он позволяет проверить, из какого класса был создан объект, учитывая наследование.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
...
const questionsJSHabr35 = [
  ...
  },
  {
    ...
    answer: {
      ...
      linkName: "35 вопросов с собеседования JavaScript-разработчика",
      answer1:
        "Здесь дело в том, что круглые скобки вызова функции добавлены сразу после Function Declaration. Однако, они могут следовать только за выражением (expression). Поэтому мы должны либо прибегнуть к варианту с Function Expression, либо обернуть Function Declaration в скобки, тем самым превратив его в выражение. const foo = function(){}() // либо (function foo(){})() // либо со стрелочной функцией (() => {})()",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      ...
      linkName: "35 вопросов с собеседования JavaScript-разработчика",
      answer1:
        "null - это в прямом смысле 'ничего'. Можно использовать это значение в качестве плейсхолдера. undefined - это значение для случая 'объявлено, но не инициализировано'. undeclared - это ошибка, возникающая в случае обращении к необъявленной переменной.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      ...
      linkName: "35 вопросов с собеседования JavaScript-разработчика",
      answer1:
        "Array.prototype.forEach - это инструмент обхода цикла процедурно, а Array.prototype.map - функционально. .forEach просто проходится по массиву с выполнением переданного обратного вызова на каждой итерации, а .map создает и возвращает новый массив на основе исходного, выкладывая по кирпичику на каждой итерации.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      ...
      linkName: "35 вопросов с собеседования JavaScript-разработчика",
      answer1:
        "AJAX = Asynchronous Javascript And XML. Это подход к асинхронному (неблокирующему) обмену данными с сервером. Изначально для решения подобной задачи использовался объект XMLHttpRequest , сейчас же более актуален дружелюбный к обещаниям (Promise) fetch API.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      ...
      linkName: "35 вопросов с собеседования JavaScript-разработчика",
      answer1:
        "Переменная foo примет значение '1020'. В JavaScript это поведение называется приведением типов. Если хотя бы один из операндов является строкой, второй также будет преобразован в строку.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
