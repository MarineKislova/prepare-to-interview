...
const questionsJSProglibPart2 = [
  ...
  },
  {
    ...
    answer: {
      ...
      linkName: "proglib.io",
      answer1:
        "<p>Оператор опциональной последовательности ?. позволяет получить безопасный доступ к вложенным свойствам объекта – даже в том случае, когда промежуточное свойство отсутствует. Оператор ?.прекращает оценку и возвращаетundefined, если часть после ?. является либоundefined, либо null.</p>",
      image1: "img/24proglibPart2.png",
      href2: "",
      linkName2: "",
      answer2: "",
      image2: "",
  ...
  },
  {
    ...
    answer: {
      ...
      linkName: "proglib.io",
      answer1:
        "<p><span>Shadow DOM</span> – это техника, позволяющая создавать изолированные фрагменты HTML и CSS в специальном сегменте DOM, который находится внутри определенного элемента. Такой подход позволяет исключить влияние инкапсулированных стилей на структуру и внешний вид основной страницы, и обеспечивает большую гибкость и контроль над представлением и поведением элементов.</p> <p>В приведенном ниже примере инкапсулированные стили пользовательского элемента не влияют на внешний вид остальной части страницы</p>  <p><img class='question__img' src='img/25proglibPart2.png' alt=''></p>",
      image1:
        "https://media.proglib.io/posts/2024/01/10/9a73b0cff11a40d5727227b04360a489.png",
      href2: "",
      linkName2: "",
      answer2: "",
      image2: "",
