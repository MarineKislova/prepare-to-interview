...
const sortedQuestionsJS = [
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>В JavaScript есть четыре способа объявления переменных:</p> <p>1. <span>myVariable = 5;</span> – неявное объявление переменной. Оно создает глобальную переменную myVariable и присваивает ей значение 5, что может привести к ошибкам в строгом режиме ('use strict').</p> <p>2. <span>var myVariable = 5;</span> – явное объявление переменной с использованием ключевого слова var. Область видимости переменной myVariable может быть функциональной или глобальной, если она объявлена вне функции. Недостаток var состоит в том, что ее область видимости не ограничивается блоком, в котором используется переменная.</p> <p>3. <span>let myVariable = 5;</span> – явное объявление переменной с использованием ключевого слова let. Область видимости такой переменной ограничивается блоком, в котором она объявлена – на уровне функции она не видна</p> <p>4. <span>const myVariable = 5;</span> – это явное объявление переменной с использованием ключевого слова const. Переменная myVariable объявляется в области видимости блока, как и let. Однако, в отличие от let, переменная myVariable является неизменяемой – ее значение не может быть изменено после объявления, за одним исключением: если значение является объектом или массивом, его свойства или элементы могут быть изменены, но сама переменная все равно остается неизменяемой</p>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>По той причине, что свойства глобальной области видимости может изменить любой JavaScript-код, имеющий к ней доступ. Также, это грозит конфликтами имен.</p>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>И то, и то является полноценной областью видимости. Различие наблюдается при использовании ключевого слова var, которое ограничивается только областью видимости функции, но не блочной областью видимости.</p>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1:"Оператор '&&' (логическое и) находит и возвращает первое ложное значение либо последний операнд, когда все значения истинные. Он использует короткое замыкание во избежание лишних затрат: <code>console.log(false && 1 && []) // false, <br> console.log(' ' && true && 5) // 5</code> При этом второй операнд не вычисляется.",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p><span>Оператор '!!'</span> <span style='font-style: italic;'>(двойное отрицание)</span> приводит значение справа от него к логическому значению.</p><code>console.log(!!null) // false,<br>console.log(!!undefined) // false,<br>console.log(!![])  //true,<br>console.log(!!1)  //true</code>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>Согласно MDN оператор ' + ' действительно является самым быстрым способом преобразования строки в число, поскольку он не выполняет никаких операций со значением, которое является числом.</p> ",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>Простыми словами, <span>event.target</span> — это элемент, в котором происходит событие, или элемент, вызвавший событие.</p> <p>Например, у нас есть такая разметка:</p> <p><img class='question__img' src='img/eventTarget.png' alt=''></p> <p>JavaScript:</p> <code>let parent = document.querySelector('.form__container');<br> let child = document.querySelector('.form__text');<br> <br> parent.addEventListener('click', function (event) {<br>   child = event.target;<br>   event.target.style.backgroundColor = 'red';<br>   event.currentTarget.style.backgroundColor = 'yellow';<br> });</code> <p>При нажатии на child <span>event.target</span> подсветится красным цветом, то есть целевой элемент form__text.</p>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p><span>Шаблонные литералы (template literals)</span> — относительно новый способ создания строк в JS. Шаблонные литералы создаются с помощью двойных обратных кавычек (``)</p> <p><img class='question__img' src='img/habr70/45habr70.png' alt=''></p> <p>Шаблонные строки также поддерживают интерполяцию строк, что позволяет вставлять выражения прямо в строку. Эти выражения заключаются в фигурные скобки ${expression} и вычисляются при создании строки</p> <p><img class='question__img' src='img/7.2proglibPart1.png' alt=''></p>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>Тернарный оператор – это сокращенная форма записи <span>if-else</span>. Он называется тернарным, потому что является единственным оператором в JavaScript, который принимает <span>три</span> аргумента. Синтаксис тернарного оператора:</p> <p><span>условие ? выражение_если_истинно : выражение_если_ложно</span></p> <p>Условие – любое условие, которое возвращает <span>true</span> или <span>false</span>.</p> <p>Выражение для истинного условия – что нужно вернуть, если условие истинно.</p> <p>Выражение для ложного условия – что нужно вернуть, если условие ложно.</p>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>Оператор опциональной последовательности ?. позволяет получить безопасный доступ к вложенным свойствам объекта – даже в том случае, когда промежуточное свойство отсутствует. Оператор ?.прекращает оценку и возвращает undefined, если часть после ?. является либо undefined, либо null.</p> <p><img class='question__img' src='img/24proglibPart2.png' alt=''></p>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>Команда <span>use strict</span> включает так называемый строгий режим. В этом режиме предупреждения становятся ошибками, что помогает в написании более чистого и безопасного кода, менее уязвимого к ошибкам в продакшене.</p> <p>Команда <span>«use strict»</span> — это директива ES5, которая заставляет весь наш код или код отдельной функции выполняться в строгом режиме. Строгий режим вводит некоторые ограничения по написанию кода, тем самым позволяя избегать ошибок на ранних этапах.</p> <p>Вот какие ограничения накладывает строгий режим:</p> <p>1. Нельзя присваивать значения или обращаться к необъявленным переменным </p> <p>2. Запрещено присваивать значения глобальный переменным, доступным только для чтения или записи</p> <p>3. Нельзя удалить «неудаляемое» свойство объекта</p>  <p>4. Запрещено дублирование параметров</p>  <p>5. Нельзя создавать функции с помощью функции eval</p> <p>6. Значением «this» по умолчанию является undefined</p> ",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
  ...
  },
  {
    ...
    answer: {
      href: "",
      linkName: "",
      answer1: "<p>this - это специальное ключевое слово в JavaScript, которое ссылается на объект, в контексте которого выполняется текущий код. Значение this зависит от контекста вызова функции и может быть разным в различных ситуациях.</p> <p>Функции (function declaration):</p> <ul> <li>В функциях объявления значение this определяется во время выполнения функции, в зависимости от способа вызова функции.</li> <li>Если функция вызывается как метод объекта, то this ссылается на сам объект, на котором вызывается метод.</li> <li>Если функция вызывается как обычная функция, то this ссылается на глобальный объект (в браузере это объект window).</li> </ul> <p>Стрелочные функции (arrow functions):</p> <ul> <li>В стрелочных функциях значение this определяется лексически, оно берется из окружающего контекста, в котором функция была определена.</li> <li>Стрелочные функции не имеют своего собственного this, поэтому они не создают новый контекст this и не зависят от способа вызова.</li> <li>Вместо этого, this в стрелочных функциях ссылается на this окружающего контекста.</li> </ul>",
      image1: "",
      href2: "",
      linkName2: "",
      answer2: "",
